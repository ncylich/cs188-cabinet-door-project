"""Retrain best model (F3: proprio+handle_pos+handle_to_eef, BC_UNet) and eval 100 episodes."""
import torch
...
def main():
    ...
    # Build obs tensor for F3 (same as ablation_sweep.build_obs_tensor)
    ...
    obs_all = torch.cat(obs_parts, dim=-1)
